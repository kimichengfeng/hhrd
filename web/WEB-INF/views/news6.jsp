...
<%--<link rel="stylesheet" type="text/css" href="<%=basePath%>css/news/default.css">--%>
		...
		<div class="container">
			...
			<div class="htmleaf-container">
				...
				<header class="htmleaf-header bgcolor-10">
					...
					<h1>
						斯凯孚推出全新的移动应用程序<span>作者：佚名 来源：转载 </span>
					</h1>
				...
				<div class="container mp30">
					<div class="newscont cl">
						<div style="text-indent: 2em;">近日，斯凯孚宣布推出一种全新的移动应用程序，该应用程序中的内容为SKF液压驱动法，可在轴承安装的过程中使用。此应用专为提高该安装方法的使用便捷性而研发，iOS和安卓系统通用，并可用于智能手机和平板。该应用是斯凯孚认可的SKF液压驱动法电脑端软件的补充应用，可从苹果的应用商店和Google
							Play下载。</div>
						<div>
							<br>
						</div>
						<div style="text-indent: 2em;">&nbsp; &nbsp;
							作为斯凯孚独有的应用，它能够让用户对安装在锥形配合面上的球面滚子轴承和CARB圆环滚子轴承进行精确的调节。通过控制轴承从预定起始位置开始的轴向推进距离，可实现正确的配合。该方法采用了一个安装在选定泵上的SKF液压螺母，该螺母装备了一个百分表和一个高精度数字压力表。</div>
						<div>
							<br>
						</div>
						<div style="text-indent: 2em;">&nbsp; &nbsp;
							当在智能手机和平板电脑上使用该应用时，当用户选择好轴承型号和配合面，应用会显示最佳安装所需的值。此外，该应用还提供安装说明。所需的值和安装说明都可以方便地保存为PDF格式。</div>
						<div>
							<br>
						</div>
					</div>
